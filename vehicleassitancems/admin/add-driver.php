...
$query->bindParam(':password',$password,PDO::PARAM_STR);
 $query->execute();
   ...
   if ($LastInsertId>0) {
    echo '<script>alert("Mechanic detail has been added.")</script>';
...
<html lang="en">
<head>
<title>Vehicle Break Down Assistance Management: Add Mechanic</title>
       ...
       <?php include_once('includes/sidebar.php');?>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Add Mechanic</a>

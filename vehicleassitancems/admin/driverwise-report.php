...
<head>
    ...
    <title>Vehicle Break Down Assistance Management: Between dates Report of orders</title>
       ...
       <?php include_once('includes/sidebar.php');?>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Mechanicwise Reports</a>
            </nav>

...
{               ?>
            ...
            <ul id="main-menu" class="metismenu">
                ...
                <li>
                    <a href="" class="has-arrow"><i class="ti-user"></i><span>Mechanic</span></a>
                    <ul>
                        <li><a href="add-driver.php">Add Mechanic</a></li>
                        <li><a href="manage-driver.php">Manage Mechanic</a></li>
                       
                    </ul>
                </li>
                <li>
                    <a href="" class="has-arrow"><i class="ti-pencil-alt"></i><span> Edit Page</span></a>
                    <ul>
                ...
                <li>
                    <a href="javascript:void(0)" class="has-arrow"><i class="ti-view-list"></i><span>Mechanic Response</span></a>
                    <ul>
                ...
                <li class="open-top">
                    ...
                    <ul>
                        ...
                        <li><a class="dropdown-item" href="driverwise-report.php">Mechanicwise report</a></li>

...
$query->bindParam(':eid',$eid,PDO::PARAM_STR);
 $query->execute();
  ...
  echo '<script>alert("Mechanic detail has been updated")</script>';
...
<html lang="en">
<head>
<title>Vehicle Break Down Assistance Management: Update Mechanic</title>
       ...
       <?php include_once('includes/sidebar.php');?>
        ...
        <div class="page">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                <a class="navbar-brand" href="javascript:void(0);">Update Mechanic</a>

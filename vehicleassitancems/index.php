...
<![endif]-->
       ...
       <?php include_once('includes/header.php');?> <!--('includes/header.php')-->
        <!-- slider area start -->
        <div class="slider-area">
            <div class="bend niceties preview-1">
                <!-- slider images start -->
                <div id="nivoslider" class="slides">
                    <img src="img1/slider/car1.jpg" alt="slider_1" title="#slider-direction-1"/>
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-9">
                                    <!-- layer 1 -->
                                    <div class="layer-1-1">
                                        <h2 class="title-1">Vehicle Breakdown </h2>
                                    </div>
                                    <!-- layer 2 -->
                                    <div class="layer-1-2">
                                        <h2 class="title-2">Assistance & Recovery </h2>
                                    </div>
